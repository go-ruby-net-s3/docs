...
The public API lives at the module root (`github.com/go-ruby-net-s3/net-s3`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `net-s3`, while the surface follows
...
```go
import "github.com/go-ruby-net-s3/net-s3"
```
...
- **[pkg.go.dev/github.com/go-ruby-net-s3/net-s3](https://pkg.go.dev/github.com/go-ruby-net-s3/net-s3)**

The module's [README](https://github.com/go-ruby-net-s3/net-s3#readme) carries worked
