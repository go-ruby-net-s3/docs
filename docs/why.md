...
`go-ruby-net-s3/net-s3` reimplements Ruby's `net-s3` in **pure Go, with cgo disabled**. The slice of
...
- any Go program can import `github.com/go-ruby-net-s3/net-s3` directly, with no Ruby runtime;
