# go-ruby-net-s3 documentation

**Pure-Go, MRI-4.0.5-faithful Ruby net-s3 (no cgo)**

`go-ruby-net-s3/net-s3` is a faithful, pure-Go (zero cgo) reimplementation of Ruby's `net-s3`,
matching reference Ruby (MRI) behaviour. The module path is
`github.com/go-ruby-net-s3/net-s3`.
...
!!! success "Status: pure-Go, CGO=0, differential-tested"
    A faithful pure-Go port of Ruby's `net-s3`, validated against reference Ruby, at 100%
...
| Repo | What it is |
| --- | --- |
| [`net-s3`](https://github.com/go-ruby-net-s3/net-s3) | the library — Ruby's `net-s3` in pure Go |
| [`docs`](https://github.com/go-ruby-net-s3/docs) | this documentation site (MkDocs Material, versioned with mike) |
| [`go-ruby-net-s3.github.io`](https://github.com/go-ruby-net-s3/go-ruby-net-s3.github.io) | the organization landing page (Hugo) |
| [`brand`](https://github.com/go-ruby-net-s3/brand) | logo and brand assets |
...
Source lives at [github.com/go-ruby-net-s3/net-s3](https://github.com/go-ruby-net-s3/net-s3).
